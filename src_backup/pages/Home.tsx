  ...
  return (
    <div className="flex items-center justify-center min-h-[60vh]">
      <section className="grid grid-cols-1 md:grid-cols-3 gap-6 w-full max-w-4xl">
        ...
        <button className="flex flex-col items-center justify-center p-8 bg-white border-2 border-gray-100 text-gray-700 rounded-2xl shadow-lg hover:bg-gray-50 hover:border-rose-100 transition-colors transform hover:-translate-y-1">
